...
class LinuxPackage(Package):
    ...
    def _init_data(self):
        ...
        xlwt_lexer_path = os.path.join(self.python_path, 'python3.6/site-packages/xlwt/ExcelFormulaLexer.py')
        xlwt_parser_path = os.path.join(self.python_path, 'python3.6/site-packages/xlwt/ExcelFormulaParser.py')
...
class WindowsPackage(Package):
    ...
    def _init_data(self):
        ...
        # 路径
        distutils_path = os.path.join(os.path.dirname(opcode.__file__), 'distutils')
        xlwt_lexer_path = os.path.join(self.python_path, 'Lib/site-packages/xlwt/ExcelFormulaLexer.py')
        xlwt_parser_path = os.path.join(self.python_path, 'Lib/site-packages/xlwt/ExcelFormulaParser.py')
        self.build_exe_options = {
            'packages': ['pandas', 'numpy'],
            'include_files': [(distutils_path, 'lib/distutils'),
                              (xlwt_lexer_path, 'lib/xlwt/ExcelFormulaLexer.py'),
